...
public class AdminPage {
    ...
    public WebElement totalGroupsResult;

    @FindBy(xpath =  "//button[.='Delete']")
    public WebElement deleteBtn;

    @FindBy(xpath = "//div[8]/div[3]/div/div/p")
    public WebElement deleteWindowHeader;

    @FindBy(xpath = "(//header)[2]/../div/div[1]/div")
    public List<WebElement> groupCardList;

    public int getTotalGroups(){
        String totalResultStr = totalGroupsResult.getText();
